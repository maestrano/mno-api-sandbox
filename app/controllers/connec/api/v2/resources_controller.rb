class Connec::Api::V2::ResourcesController < ApplicationController
  ...
  ACCEPTED_RESOURCES = {
    ...
    "SalesOrder"       => { arity: 'collection' },
    "PurchaseOrder"    => { arity: 'collection' },
    "Quote"            => { arity: 'collection' },
    "Payment"          => { arity: 'collection' },
    "StockAdjustment"  => { arity: 'collection' },
    "Journal"          => { arity: 'collection' },
    ...
    "Warehouse"        => { arity: 'collection' },
    "Event"            => { arity: 'collection' },
    "Venue"            => { arity: 'collection' },
    "EventOrder"       => { arity: 'collection' },
    "WorkLocation"     => { arity: 'collection' },
    "PayItem"          => { arity: 'collection' },
    "Employee"         => { arity: 'collection' },
    "PaySchedule"      => { arity: 'collection' },
    "TimeSheet"        => { arity: 'collection' },
    "TimeActivity"     => { arity: 'collection' },
    "PayRun"           => { arity: 'collection' },
    "PayStub"          => { arity: 'collection' },
    "LeaveApplication" => { arity: 'collection' },
    "TransactionLog"   => { arity: 'collection' },
    "ConnectorSync"    => { arity: 'collection' }
  }
